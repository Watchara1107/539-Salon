          ...
          <div class="card-body">
            <form action="{{ url('/admin/booking/update/'.$booking->id) }}" method="post">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                      <input class="form-control" type="text" name="name" value="{{ $booking->name }}" id="html5-text-input" />
                    </div>
                  </div>
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                      <input class="form-control" type="text" name="email" value="{{ $booking->email }}" id="html5-email-input" />
                    </div>
                  </div>
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                      <input class="form-control" type="tel" name="phone" value="{{ $booking->phone }}" id="html5-tel-input" />
                    </div>
                  </div>
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                      <input class="form-control" type="date" name="date" value="{{ $booking->date }}" id="html5-date-input" />
                    </div>
                  </div>
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                      <input class="form-control" type="time" name="time" value="{{ $booking->time }}" id="html5-time-input" />
                    </div>
                  </div>
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                      <input class="form-control" type="text" name="manu2" value="{{ $booking->manu2}}" id="html5-tel-input" />
                    </div>
                  </div>
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                      <input class="form-control" type="text" name="status" value="{{ $booking->status}}" id="html5-tel-input" />
                    </div>
                  </div>
